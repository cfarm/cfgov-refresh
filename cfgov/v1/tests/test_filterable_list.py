...
class TestFilterableListMixin(TestCase):
    ...
    @mock.patch('django.core.paginator.Paginator')
    @mock.patch('v1.util.filterable_list.FilterableListMixin.get_page_set')
    @mock.patch('v1.util.filterable_list.FilterableListMixin.per_page_limit')
    def test_process_forms_calls_is_valid_on_each_form(self, mock_paginator, mock_per_page_limit, mock_get_page_set):
        ...
        # get_request.site.hostname = 'content.localhost'
        # get_request.GET = self.factory.get('/').GET
        # self.mixin.specific = mock.Mock()
        # mock_form = mock.Mock()
        # mock_form.return_value = mock.Mock()
        # mock_form.is_valid.return_value = False
        # self.mixin.specific.get_form_class.return_value = mock_form
        # mock_formdata.return_value = {'0':{}}
